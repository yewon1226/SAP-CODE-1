...
```abap
INSERT <추가할_행> INTO <인터널_테이블>.                " 조건 없으면 끝에 추가
INSERT <추가할_행> INTO <인터널_테이블> INDEX <위치>.   " 특정 위치에 삽입
INSERT LINES OF <다른_테이블> INTO TABLE <인터널_테이블>.
```
```abap
INSERT flight INTO flights_table INDEX 2.
INSERT flight INTO flights_table.  " 맨 끝
```
</br>
