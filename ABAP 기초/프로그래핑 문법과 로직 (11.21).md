...
INSERT <행> INTO <인터널_테이블> INDEX <번호>.                " 특정 위치에 삽입
INSERT LINES OF <소스_테이블> INTO TABLE <인터널_테이블>.
INSERT LINES OF <소스_테이블> INTO <대상_테이블> INDEX <번호>. " 특정 위치에 삽입
```
```abap
...
MODIFY <인터널_테이블> FROM <행> INDEX <번호>.
```
```abap
