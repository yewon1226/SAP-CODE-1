...
| OPTION | 범위 적용 방식 |
|--------|----------------|
| EQ     | LOW 값과 같은 값만 선택 (HIGH 사용 안 함) |
| BT     | LOW~HIGH 범위 값만 선택 |
| GE     | LOW 이상 값 선택 (HIGH 사용 안 함) |
| LE     | LOW 이하 값 선택 (HIGH 사용 안 함) |
| GT     | LOW 초과 값 선택 (HIGH 사용 안 함) |
| LT     | LOW 미만 값 선택 (HIGH 사용 안 함) |
| CP     | 패턴 매칭 (*, ?) |
| NE     | LOW 값과 다른 값 선택 (HIGH 사용 안 함) |
| NP     | 패턴 불일치 선택 |
