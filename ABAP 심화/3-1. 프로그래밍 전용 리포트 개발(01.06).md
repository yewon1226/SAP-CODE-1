...
```abap
INSERT <DB_TABLE> FROM <WORK_AREA>.    " 워크에어리어의 데이터를 DB 테이블에 1건 저장
```
```abap
...
- `SM36` 로 JOB 생성하기
<img width="425" height="264" alt="image" src="https://github.com/user-attachments/assets/84b88305-b4e2-41c0-8750-f3ea01f3b74b" />
