...
<img width="556" height="407" alt="image" src="https://github.com/user-attachments/assets/86bb2c4e-3e33-4687-b353-7611d2326416" />
</br>
</br>
...
**1) 로컬 스크롤링**
- Tab Page가 여러 개일 때 각 Tab Page마다 Subscreen Area를 따로 가짐
- 탭별로 화면·데이터를 독립적으로 관리
- 구현은 단순하지만 서브스크린이 여러 개 필요
  
**2) PAI 스크롤링**
- Tab Page가 여러 개여도 Subscreen Area는 1개만 사용
- 탭 선택 시 PAI에서 표시할 서브스크린을 교체(재사용)
- 구조는 복잡하지만 유지보수·재사용성 좋음
</br>
