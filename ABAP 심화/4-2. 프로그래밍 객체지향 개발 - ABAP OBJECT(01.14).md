...
- **5) Inheritance (상속)**
- **6) 메서드 재정의(Redefinition)**
- **7) 서브클래스 생성자 정의(Constructor in Subclass)**
- **8) 상속과 접근제어(PROTECTED)**
...
- 결과 확인
<img width="350" height="266" alt="image" src="https://github.com/user-attachments/assets/1983d3f6-0a31-425e-8b80-7d293527d4fd" />
