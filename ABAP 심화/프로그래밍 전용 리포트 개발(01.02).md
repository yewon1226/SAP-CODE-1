...
DATA: BEGIN OF gs_data.
        INCLUDE TYPE <DB_STR>.
DATA: <BTN_FIELD> TYPE c LENGTH 10,
      <STYLE_FLD> TYPE lvc_t_styl,
     END OF gs_data.

DATA: gt_data       TYPE STANDARD TABLE OF gs_data,
      gs_data       TYPE gs_data,
...
CLASS lcl_event_handler IMPLEMENTATION.
  METHOD on_button_click.
    IF es_col_id-fieldname = '<BTN_FIELD>'.
...
FORM get_data.
  ...
  LOOP AT gt_data INTO gs_data.
    IF <BTN_COND>.
      gs_cell_style-fieldname = '<BTN_FIELD>'.
      gs_cell_style-style     = cl_gui_alv_grid=>mc_style_button.
      APPEND gs_cell_style TO gs_data-<STYLE_FLD>.
      gs_data-<BTN_FIELD> = '<BTN_TEXT>'.
    ENDIF.
...
*************** PBO ****************
SET HANDLER lcl_event_handler=>on_button_click FOR <ALV_OBJ>.

gs_layout-stylefname = '<STYLE_FLD>'.
