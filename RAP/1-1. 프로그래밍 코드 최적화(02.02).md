...
*************** 내부테이블 + Work Area (LOOP) 기존 방식 ****************
DATA gs_line TYPE LINE OF gt_itab.
LOOP AT gt_itab INTO gs_line.
  " 로직
ENDLOOP.

*************** 내부테이블 + Work Area (LOOP) 최신 방식 ****************
LOOP AT gt_itab INTO DATA(gs_line).
  " 로직
ENDLOOP.

*************** 내부테이블 + Work Area (READ) 기존 방식 ****************
DATA gs_line TYPE LINE OF gt_itab.
READ TABLE gt_itab INTO gs_line INDEX n.

*************** 내부테이블 + Work Area (READ) 최신 방식 ****************
READ TABLE gt_itab INTO DATA(gs_line) INDEX n.

*************** 메서드 IMPORTING 파라미터 기존 방식 ****************
...
*************** 필드심볼 READ 기존 방식 ****************
FIELD-SYMBOLS <line> TYPE LINE OF gt_itab.
READ TABLE gt_itab ASSIGNING <line> INDEX n.
