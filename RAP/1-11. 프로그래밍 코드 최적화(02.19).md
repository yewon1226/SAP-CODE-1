<img width="633" height="159" alt="image" src="https://github.com/user-attachments/assets/8e3811b5-0120-4aa4-a476-be8dffba3261" />## <  핵심 개념 >
...
<img width="471" height="366" alt="image" src="https://github.com/user-attachments/assets/6261ac4a-f755-4288-9ec2-a0a1eaecd83c" />
</br>
</br>
...
define table ztscarr_c203 {                      " DB 테이블 생성
  ...
  key client : abap.clnt not null;               " 기본키 1 (클라이언트)
  key carrid : s_carr_id not null;               " 기본키 2 (항공사 ID)

  carrname   : s_carrname;                       " 일반 필드 (항공사 이름)
