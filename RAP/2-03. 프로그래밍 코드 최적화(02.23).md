...
" [1,1]       → Source 1건 ↔ Target 1건 (필수 일대일)
" [0..1,1]    → Source 1건 ↔ Target 0 또는 1건 (옵션 일대일)
" [1,0..1]        → Source는 필수, Target은 옵션
" [1..*,1]    → 여러 Source ↔ Target 1건 (다대일)
" [0..*,1]    → 여러 Source(옵션 포함) ↔ Target 1건
