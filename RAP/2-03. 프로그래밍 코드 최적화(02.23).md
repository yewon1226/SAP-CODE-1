...
```
```abap
define view entity ZI_Employee as select from zemp
  association [ ? ] to zdept as _Department
    on $projection.DeptCode = _Department.dept_id
{
  key emp_no as EmployeeNumber,
  dept_code as DeptCode
}

association [0..*] to scarr as _Carrier
