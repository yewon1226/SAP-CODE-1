...
<img width="251" height="135" alt="image" src="https://github.com/user-attachments/assets/0783d8c9-f002-402e-acd9-1f2a185721de" />
...
sap.ui.define([
    ...
    return Controller.extend("test1.controller.Main", {
        ...
        onPress: function () {
            ...
            let str = "이름: " + oModel.getProperty("/name/FirstName") + oModel.getProperty("/name/LastName") + "\n" +
                        "나이: " + oModel.getProperty("/age") + "\n" +
                        "연봉: " + oModel.getProperty("/salary");
            sap.m.MessageBox.information(str);
        }
    });
});
```
