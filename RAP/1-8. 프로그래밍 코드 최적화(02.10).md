...
sap.ui.define([
    ...
    return Controller.extend("sap.btp.zuiprogb03.controller.Main", {
        onInit() {
        ...
        onCreate: function() {
            ...
            if(oDialog) {      
                ...
                Fragment.load({
                    name: "sap.btp.zuiprogb03.view.fragment.CreateDialog",        
                    type: "XML",        
                    controller: this    
        ...
        onUpdate: function() {
            ...
            if(oDialog) {      
                sap.ui.getCore().byId("idUpdateDialog").getModel("oUpdateModel").setData(oData);
                oDialog.open();
            }
            else {
                Fragment.load({
                    name: "sap.btp.zuiprogb03.view.fragment.UpdateDialog",        
                    type: "XML",        
                    controller: this    
                }).then(function(oDialog) {
