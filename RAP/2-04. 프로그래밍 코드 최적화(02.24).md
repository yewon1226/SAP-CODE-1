...
| From            | To                          | 비고                         |
|---------------|----------------------------|------------------------------|
| CHAR          | CHAR, NUMC, UNIT, CUKY     | 길이가 충분해야 함           |
| NUMC          | CHAR, NUMC                 |                              |
| DEC, CURR, QUAN | DEC, CURR, QUAN, FLTP     |                              |
| FLTP          | DEC, CURR, QUAN            |                              |
| DATS, TIMS    | CHAR                       | 날짜를 문자열로 다룰 때 사용 |
| INT1, INT2, INT4 | INT, DEC, FLTP          |                              |
