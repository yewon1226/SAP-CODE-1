...
- data-sap-ui-resource-roots : 앱의 네임스페이스(sap.ui5.yui5project01)는 실제 파일 경로상에서는 현재 폴더(./)에 있
```html
<script
        id="sap-ui-bootstrap"
...
- SAPUI5 실행 순서 : index.html -> Component.js -> manifest.json -> App.view.xml (rootview에 의해) -> App.controller.js (controllername에 의해)
